...
public class Projectiler {
     ...
     */
    public Date checkout(final String projectName) throws ProjectilerException, IllegalStateException,
    ...
    public void saveCredentials(final String username, final String password) throws ProjectilerException {
        try {
